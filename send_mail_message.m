function send_mail_message(email,subject,message,attachment)
...
mail = 'j.jakubowicz11@gmail.com';    %Your GMail email address
password = 'XXXXXXX';          %Your GMail password
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% Send the email
if strcmp(mail,'j.jakubowicz@gmail.com')
...
sendmail(email,subject,message,attachment)
